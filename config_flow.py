...
from .const import DISPATCH_CONTROLLER_DISCOVERED, ESCEA, TIMEOUT_DISCOVERY
...
config_entry_flow.register_discovery_flow(ESCEA, "Escea Fireplace", _async_has_devices)
